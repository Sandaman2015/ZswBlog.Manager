<template>
  <div style="padding:30px">
    <div v-for="(item,index) in imgList" :key="index" class="item">
      <div class="container">
        <el-image :src="item.path" :preview-src-list="imgList.path" alt="图片列表" style="width: 220px; height: 200px"
          fit="cover" />
    ...
    <div class="block">
      <el-pagination background :page-size="page.pageSize" @current-change="handleCurrentChange"
        :current-page.sync="page.pageIndex" :total="total">
      </el-pagination>
    </div>
  </div>
</template>
