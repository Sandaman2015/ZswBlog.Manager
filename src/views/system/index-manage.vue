<template>
  <div style="padding:30px">
    <div class="demonstration" style="padding:30px">
      <h3>首页配置预览：</h3>
      <el-divider />
      <video v-show="videoInfo.videosrc" ref="localVideo" autoplay controls loop :src="videoInfo.videosrc" />
    ...
    <div class="content" style="padding:30px">
      ...
      <el-form ref="videoInfo" :model="videoInfo" label-width="80px">
        <el-form-item label="视频地址">
          <el-input v-model="videoInfo.videosrc" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item label="视频插图">
          <el-input v-model="videoInfo.poster" placeholder="请输入内容" />
        </el-form-item>
        <el-form-item v-if="videoInfo.videosrc" label="视频音量">
          <el-input-number v-model="videoInfo.volume" :min="0" :max="1" :step="0.1" label="视频音量" />
        </el-form-item>
        <el-divider />
