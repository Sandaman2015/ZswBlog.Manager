...
export function getIllustrationConfig() {
  return request({
    url: `/api/config/get/illustration`,
    method: 'get'
  })
}
/**
...
export function updateDetailsConfig(data) {
  return request({
    url: `/api/config/admin/update/details`,
    method: 'post',
    data
  })
}
...
export function updateIllustrationConfig(data) {
  return request({
    url: `/api/config/admin/update/illustration`,
    method: 'post',
    data
  })
}
...
export function updateIndexConfig(data) {
  return request({
    url: `/api/config/admin/update/index`,
    method: 'post',
    data
  })
}
